...
class BaseOptions:
    ...
    def initialize(self):
        self.parser.add_argument(
            "--dataset_file", default="/your_data_root/MUSICDataset/solo/"
        )
        self.parser.add_argument(
            "--val_dataset_file", default="/your_data_root/MUSICDataset/solo/"
        )
        # self.parser.add_argument('--mean_path', default='/your_data_root/MUSICDataset/solo/')
        self.parser.add_argument(
            "--annotation_path", default="/your_data_root/MUSICDataset/solo/"
        )
        ...
        self.parser.add_argument(
            ...
            type=str,
            default="train",
            help="name of the mode. Is it training or testing?",
        )
        ...
        self.parser.add_argument(
            "--nThreads", default=16, type=int, help="# threads for loading data"
        )
