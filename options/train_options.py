...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=10,
            help="frequency of displaying average loss and accuracy",
        )
        self.parser.add_argument(
            "--save_latest_freq",
            type=int,
        ...
        self.parser.add_argument(
            "--epoch_count", type=int, default=0, help="the starting epoch count"
        )
        self.parser.add_argument(
            "--decay_factor",
            type=float,
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=500,
            help="frequency of testing on validation set",
        )
        ...
        # optimizer arguments
        self.parser.add_argument(
            "--lr_rate", type=float, default=0.0001, help="learning rate for training"
        )
        self.parser.add_argument(
            "--lr_steps",
            nargs="+",
            type=int,
            default=[10000, 20000],
            help="steps to drop LR in training samples",
        )
        self.parser.add_argument(
            "--optimizer", default="sgd", type=str, help="adam or sgd for optimization"
        )
        self.parser.add_argument(
            "--beta1", default=0.9, type=float, help="momentum for sgd, beta1 for adam"
        )
        self.parser.add_argument(
            "--weight_decay", default=0.0001, type=float, help="weights regularizer"
        )
        self.mode = "train"
